...
template <class Grid, class Phase>
        struct ConcProb: BaseProblem<concTraits<Grid>>
            ...
            public:
                ...
                auto gradPhi() const     {return gradientOf(phi_);}
                auto absGradPhi()        {return two_norm(gradPhi()) + 1e-6;}
            ...
            public:
                ...
                void fillOperators(AdaptInfo& adaptInfo) override {
                    ...
                    //time derivative
                    this->problem().addMatrixOperator(zot(this->invTau()*absGradPhi(), 5));
                    this->problem().addVectorOperator(zot(absGradPhi()*this->invTau()*c, 5));
